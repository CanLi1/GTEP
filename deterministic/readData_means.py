...
def read_data(database_file, curPath, stages, n_stage, t_per_stage, labels, num_days):
    ...
    L_NE_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/L_Northeast_2012.csv'), index_col=0, header=0)
    L_W_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/L_West_2012.csv'), index_col=0, header=0)
    L_C_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/L_Coastal_2012.csv'), index_col=0, header=0)
    L_S_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/L_South_2012.csv'), index_col=0, header=0)
    ...
    CF_CSP_W_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_West_CSP2012.csv'), index_col=0, header=0)
    CF_CSP_C_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_Coastal_CSP2012.csv'), index_col=0, header=0)
    CF_CSP_S_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_South_CSP2012.csv'), index_col=0, header=0)
    ...
    CF_PV_W_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_West_PV2012.csv'), index_col=0, header=0)
    CF_PV_C_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_Coastal_PV2012.csv'), index_col=0, header=0)
    CF_PV_S_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_South_PV2012.csv'), index_col=0, header=0)
    ...
    CF_wind_W_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_West_wind2012.csv'), index_col=0, header=0)
    CF_wind_C_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_Coastal_wind2012.csv'), index_col=0, header=0)
    CF_wind_S_1 = pd.read_csv(os.path.join(curPath, 'NSRDB_wind/for_cluster/CF_South_wind2012.csv'), index_col=0, header=0)
