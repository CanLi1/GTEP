...
oldc = sql.connect("../data/GTEPdata_2020_2039.db")
cc = oldc.cursor()
conn = sql.connect("../data/ERCOT.db")
c = conn.cursor()
def process_param(sql_param, c):
    d = dict()
...
gens = ['coal-st-old1', 'ng-ct-old', 'ng-cc-old', 'ng-st-old', 'pv-old', 'wind-old','wind-new', 'pv-new', 'csp-new', 'coal-igcc-new', 'coal-igcc-ccs-new','ng-cc-new', 'ng-cc-ccs-new', 'ng-ct-new','nuc-st-old','nuc-st-new']  
...
FOC = process_param("FOC", cc)
VOC = process_param("VOC", cc)
